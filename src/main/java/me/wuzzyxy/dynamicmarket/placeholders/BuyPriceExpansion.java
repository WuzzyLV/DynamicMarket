...
public class BuyPriceExpansion extends PlaceholderExpansion {
    ...
    public String onRequest(OfflinePlayer player, @NotNull String params) {
        ...
        if (!(args.length == 2 || args.length == 3)) return "DMBuyPrice_Item,Amount or DMBuyPrice_Item,Amount,Percentage " + args.length + " args provided";
        ...
        try {
            ...
            if (args.length == 3) {
                ...
                price = priceHandler.getBuyPrice(item, amount, percentage);
            }else {
                price = priceHandler.getBuyPrice(item, amount);
            }
