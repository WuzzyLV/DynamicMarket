...
public class SellPriceExpansion extends PlaceholderExpansion {
    ...
    public String onRequest(OfflinePlayer player, @NotNull String params) {
        ...
        if (!(args.length == 2 || args.length == 3)) return "DMSellPrice_Item,Amount or DMSellPrice_Item,Amount,Percentage " + args.length + " args provided";
        ...
        try {
            ...
            if (args.length == 3) {
                ...
                price = priceHandler.getSellPrice(item, amount, percentage);
            }else {
                price = priceHandler.getSellPrice(item, amount);
            }
