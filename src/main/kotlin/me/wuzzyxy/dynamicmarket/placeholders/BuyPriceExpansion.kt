...
class BuyPriceExpansion(
    ...
    override fun getIdentifier(): String = "DMBuyPrice"
    ...
    override fun onRequest(player: OfflinePlayer?, params: String): String {
        ...
        if (args.size != 2) return "DMBuyPrice_Item,Amount${args.size} args provided"

        val item = manager.getWorkingItem(args[0]) ?: return "${args[0]} not found"
        val amount = args[1].toIntOrNull() ?: return "Invalid params"

        return df.format(priceHandler.getBuyPrice(item, amount))
    }
}
